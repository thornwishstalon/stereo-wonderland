...
for im_num = 1:15
    ...
    [DisparityMap{1}, DisparityMap{2},DisparityMap_sparse{1},DisparityMap_sparse{2}] = calc_depth_sdk(I{1}, I{2}, max(DisparityRange));
    ...
    if strcmp(imgset,'training')
        GT = readpfm(['MiddEval3_GT0/training',imgsize,'/',image_names{im_num},'/disp0GT.pfm']);
        mask = imread(['MiddEval3_GT0/training',imgsize,'/',image_names{im_num},'/mask0nocc.png']);
        mask = mask == 255;
